...
public class CustomAuthenticationExceptionHandler{
    ...
    static {
        ...
        DEFAULT_ERROR_LIST.add(com.myunihome.myxapp.sso.server.sso.common.exception.UsernameIsNullException.class);
        DEFAULT_ERROR_LIST.add(com.myunihome.myxapp.sso.server.sso.common.exception.SystemBusyException.class);
        DEFAULT_ERROR_LIST.add(com.myunihome.myxapp.sso.server.sso.common.exception.PasswordIsNullException.class);
        DEFAULT_ERROR_LIST.add(com.myunihome.myxapp.sso.server.sso.common.exception.TenantIdIsNullException.class);
