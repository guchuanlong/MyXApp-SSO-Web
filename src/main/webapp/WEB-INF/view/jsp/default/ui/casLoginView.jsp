...
<head>
	...
	<script type="application/javascript" src="styles/js/datacheck.js"></script>
...
<div class="login_tp"><img src="styles/images/login_tp.png"></div>
 <div id="miniLoginDiv" class="login_nr">
  ...
  <form:form method="post" id="fm1" name="fm1" commandName="${commandName}" htmlEscape="true">
	  <div class="login_tr">
	   <ul>
	   	<span id="errorSpan"><form:errors path="*" id="msg" cssClass="errors" element="div" htmlEscape="false" /></span>
	    ...
	    <li><i class="icon-lock"></i><form:password cssClass="required shuru" cssErrorClass="error" id="password" size="25" tabindex="3" path="password"  accesskey="${passwordAccessKey}" htmlEscape="true" autocomplete="off" onkeydown="encryptPwd(event)"/></li>
	    ...
	    <li><input class="login_btn" id="loginBtn" accesskey="l" value="登录" tabindex="5" type="button"  onclick="javascript:dologin();"  /></li>
	   </ul>
